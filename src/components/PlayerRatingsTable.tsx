        ...
        <div className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
            ...
            <table className="min-w-full bg-white dark:bg-gray-800 rounded-lg overflow-hidden">
                ...
                <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                    <td className="py-3 px-4 text-gray-900 dark:text-gray-100 font-bold">Short
                        Distance: {typeRatings.shortDistanceOvr}</td>
                ...
                <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                    <td className="py-3 px-4 text-gray-900 dark:text-gray-100 font-bold">Middle
                        Distance: {typeRatings.middleDistanceOvr}</td>
                ...
                <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                    <td className="py-3 px-4 text-gray-900 dark:text-gray-100 font-bold">Long
                        Distance: {typeRatings.longDistanceOvr}</td>
                    <td className="py-3 px-4 text-gray-900 dark:text-gray-100">Injury
                        Resistance: {injuryResistance}</td>
