...
export default function ManualPage() {
    return (
        <main className="min-h-screen bg-background-light dark:bg-background-dark">
            <section className="border-b border-neutral-200/70 dark:border-neutral-800/70 bg-gradient-to-b from-neutral-50/60 to-transparent dark:from-neutral-900/40">
                        ...
                        <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-3">
                            {[
                                ...
                                >
                                    ...
                                    <div className="text-sm font-medium text-neutral-900 dark:text-neutral-100">{s.v}</div>
                                </div>
                            ))}
                        </div>
                    </div>
                ...
                <div className="grid lg:grid-cols-[220px_1fr] gap-10">
                    <aside className="hidden lg:block">
                        <nav className="sticky top-[72px]">
                            <div className="text-xs font-medium text-neutral-500 dark:text-neutral-400 mb-2">On this page</div>
                    ...
                    <article className="max-w-3xl space-y-7 md:space-y-14">
                        <div className="rounded-lg border border-neutral-200/70 dark:border-neutral-800/70 bg-white dark:bg-neutral-900 overflow-hidden">
                            <div className="px-4 py-3 border-b border-neutral-200/70 dark:border-neutral-800/70 text-sm font-medium text-neutral-800 dark:text-neutral-200">
                                Quick Start
                            </div>
                        ...
                        <Section id="ui" title="Interface">
                            <ul className="list-disc pl-5 space-y-1">
                                <li><span className="font-medium">Sidebar</span>: Dashboard; League → Teams, Standings, Meets, Races; Team → Roster; Players → Ratings; Stats; Tools; Help.</li>
                                <li><span className="font-medium">Tables</span>: click headers to sort; links open detail pages.</li>
                        ...
                        <Section id="rules" title="League Rules">
                            <ul className="list-disc pl-5 space-y-1">
                                <li><span className="font-medium">Scheduling</span>: weekly cadence; bracketed championships.</li>
                                <li><span className="font-medium">Customization</span>: planned “God Mode” for editing teams, players, schedules, and rules.</li>
                            </ul>
                        </Section>
                        ...
                        <Section id="events" title="Events & Scoring">
                            <p className="mb-3">Cross country uses 8k scoring; track includes common events from 100m to 10k.</p>
...
function Card({ title, children }: { title: string; children: React.ReactNode }) {
    return (
        <div className="rounded-lg border border-neutral-200/70 dark:border-neutral-800/70 bg-white dark:bg-neutral-900 p-4">
